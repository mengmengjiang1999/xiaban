"""Collect a packaged build and authored materials; this does not upload or certify QA."""
...
(OUTPUT / "上传说明.md").write_text(
    f"# 《下班》{manifest['version']} 上传材料\n\n"
    "这份目录尚未上传。材料整理与摘要核对不代表完成玩法或稳定性验收。\n"
    "上传前须核对 docs/发布前稳定性测试记录.md 的本版本结果，先完成镜头、视线频闪和稳定性验证。\n"
    "具备本轮验证结果后，再使用用户自己的 itch.io 账号和项目，保持草稿页面，完成托管验收后公开。\n\n"
    ...
    "5. 在真实托管页面检查加载、开始、方向键视角与 WASD 分离、C/Space、暂停继续、失焦、三位领导失败、通关与音量保存。\n\n"
    "1.0.0 的 Chrome 67项与引擎92项是历史基线，不替代当前包验证；Safari 历史结果只有真实操作烟测。\n"
